...
import java.util.Map;
    ...
    public class Lab03 extends Application {
        ...
        public void start(Stage stage) {
            ...
            for (int i = 4; i < amountOfColomns - 1; i++) {
...
//            final Label label2 = new Label("f1 = " +   + " f2 = " +  + " f3 = " + + " f4 = " + );
//            label2.setFont(new Font("Times New Roman", 20));
//
//            final Label label3 = new Label("Normalized regression: y = " + m.getNormalizedRegressionCoeffs()[0] + " + " +
//                    m.getNormalizedRegressionCoeffs()[1] + " * x1 + " + m.getNormalizedRegressionCoeffs()[2] + " * x2");
//            label3.setFont(new Font("Times New Roman", 20));
//
//            final Label label4 = new Label("Natural regression: y = " + m.getNaturalizedRegressionCoeffs()[0] + " + " +
